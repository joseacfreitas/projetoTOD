...
require_once("enviar_dados_Ator_Atriz.php");

require_once("conetar.php");

$pag = (isset($_GET['pagina'])) ? $_GET['pagina'] : 1;

$busca = "SELECT *FROM actores  ORDER BY `actores`.`nome` ASC ";
...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="CSS/style_atores_atrizes.css">

    <title>Pagina Atores/Atrizes</title>
...
<body>
    ...
    <marquee class="bvin">
        <?php
        echo "<h2>Bem vindo à página de Atores/Atrizes ,  <u>$email</u> .</h2>";
        ?>
    </marquee>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content ">
                ...
                <div class="modal-header ">
                    ...
                    <h3 class="modal-title2" id="TituloModalCentralizado">Insira um Ator ou Atriz</h3>
                ...
                <div class="modal-body">
                    ...
                    <form method="post">
                        <div class="form-group">
                            ...
                            <input type="text" name="nome" class="form-control" placeholder="Nome Ator ou Atriz." required>
                        </div>
                        <br>
                        <div class="form-group">
                            <label for="morada">Morada</label>
                            <input type="text" name="morada" class="form-control" placeholder="Morada do Ator/Atriz." required>
                        </div>
                        <br>
                        <div class="form-group">
                ...
                <h5 class="modal-title" id="TituloModalCentralizado"> <span style="color: #f00;">AVISO:</span> <i>certifique-se que o Ator ou Atriz que deseja inserir, não existe na lista.</i></h5>
