...
include('enviar_dados_estudios.php');

require_once("conetar.php");

$pag = (isset($_GET['pagina'])) ? $_GET['pagina'] : 1;

$busca = "SELECT * FROM estudios";
...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="CSS/style_estudios.css">

    <title>Pagina Estudios</title>
...
<body>
    ...
    <marquee class="bvin">
        <?php
        echo "<h2>Bem vindo à página de Estudios ,  <u>$email</u> .</h2>";
        ?>
    </marquee>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header ">
                    ...
                    <h3 class="modal-title2" id="TituloModalCentralizado">Insira Estudio</h3>
                ...
                <div class="modal-body">
                    ...
                    <form method="post">
                        <div class="form-group">
                            ...
                            <input type="text" name="nome" class="form-control" placeholder="Nome do Estudio." required>
                        </div>
                        <br>
                        <div class="form-group">
                            <label for="morada">Morada</label>
                            <input type="text" name="morada" class="form-control" placeholder="Morada do Estudio." required>
                        </div>
                        <br>
                        <div class="form-group">
                            <label for="país">País</label>
                            <input type="text" name="país" class="form-control" placeholder="Insira o país dp Estudio.">
                        </div>
                        <br>
